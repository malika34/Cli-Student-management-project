...
// Course data
const courses = [
    { name: 'AI', price: 3000 }, // Course: AI, Price: $3000
    { name: 'Web 3.0', price: 2000 }, // Course: Web 3.0, Price: $2000
    { name: 'Metaverse', price: 2000 }, // Course: Metaverse, Price: $2000
...
class Student {
    name: string;
    studentID: string;
    coursesEnrolled: { name: string, paid: boolean }[];
    balance: number;
    ...
    enroll(course: string, paid: boolean): void {
    ...
    payTuition(amount: number, coursePrice: number): void {
